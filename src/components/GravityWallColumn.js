...
class GravityWallColumn extends Component{
    ...
    solveGravityWall(){
        ...
        //new GravityRetainingWall({a:2.5, b : 0.6, c: 0.4, d : 0.5, e : 1.0, f : 1.0, g : 1.5, h : 8.5})
        //setConstantTerms();
        ...
        //wall.givenData({q_ultimate:560, beta : 10, phi1 : 32, rho: 12,  phi : 32, F : 2});
        //console.log(`${q_ultimate}-${Beta}-${Phi}-${Phi1}-${Rho}-${F}`);
    ...
    render(){
        ...
        <tbody>
            <tr>
                ...
                <td>{ GravityRetainingWall.prototype.isPrototypeOf(this.state.wall_obj) ? this.state.wall_obj.activePressure(): 'N/A'}</td>
                <td>Eccentricity</td>
                <td>{GravityRetainingWall.prototype.isPrototypeOf(this.state.wall_obj) ? this.state.wall_obj.eccentricity(): 'N/A'}</td>
            ...
            <tr>
                ...
                <td>{GravityRetainingWall.prototype.isPrototypeOf(this.state.wall_obj) ? (this.state.wall_obj.isDesignEfficient(()=> this.state.wall_obj.eccentricity()) ? "Yes" :"No" ): 'N/A'}</td>
            ...
            <tr>
                <td>W1 Shape 1</td>
                <td>{GravityRetainingWall.prototype.isPrototypeOf(this.state.wall_obj) ? this.state.wall_obj.w1(): 'N/A'}</td>
                <td>W2 Shape 2</td>
                <td>{GravityRetainingWall.prototype.isPrototypeOf(this.state.wall_obj) ? this.state.wall_obj.w2(): 'N/A'}</td>
                <td>W3 Shape 3</td>
