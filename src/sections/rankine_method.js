...
GravityRetainingWall.prototype.ka = function(){
    ...
    (this.Mathh._cos(this.beta) + Math.sqrt(Math.pow(this.Mathh._cos(this.beta),2) - Math.pow(this.Mathh._cos(this.phi1),2))))).toFixed(2);
    
}
GravityRetainingWall.prototype.activePressure = function(){
    return (0.5 * constants.r * Math.pow(this.Ha,2) * this.ka()).toFixed(2)        ;
}
/**
 * For W1 (Shape 1, triangle)
 */
GravityRetainingWall.prototype.w1 = function(){
    this.W1 = (0.5 * this.g * (this.wall_height - this.f) * constants.rc).toFixed(2);
    return this.W1;
}
/**
...
GravityRetainingWall.prototype.w2 = function(){
    this.W2 = (this.top_thickness * (this.wall_height - this.f)* constants.rc).toFixed(2);
    return this.W2;
}
/**
...
GravityRetainingWall.prototype.w3 =  function(){
    this.W3 = (0.5 * this.b * (this.wall_height - this.f) * constants.rc).toFixed(2);
    return this.W3;
}
/**
...
GravityRetainingWall.prototype.w4 = function(){
    this.W4 = (this.B * this.f * constants.rc).toFixed(2);
    return this.W4;
}
 
GravityRetainingWall.prototype.w5 = function(){
    this.W5 = (this.heel_length * (this.wall_height - this.f) * constants.r).toFixed(2);
    return this.W5;
}

GravityRetainingWall.prototype.w6 = function(){
    this.W6 = (0.5 * this.g * (this.wall_height - this.f) * constants.r).toFixed(2);
    return this.W6;
}

GravityRetainingWall.prototype.w7 = function(){
    this.W7 = (0.5 * (this.g + this.heel_length) * this.h * constants.r).toFixed(2);
    return this.W7;
}

GravityRetainingWall.prototype.Ph = function(){
    return (this.activePressure() * this.Mathh._cos(this.beta)).toFixed(2);
}

GravityRetainingWall.prototype.Pv = function(){
    return (this.activePressure() * this.Mathh._sin(this.beta)).toFixed(2);
}

//Lever arm about A, (m)
GravityRetainingWall.prototype.leverArmX1 = function(){
    return ((2/3) * this.g + this.heel_length).toFixed(2);
}
GravityRetainingWall.prototype.leverArmX2 = function(){
    return ((this.top_thickness/2) + this.g + this.heel_length).toFixed(2);
}

GravityRetainingWall.prototype.leverArmX3 = function() {
    return ((this.b / 3) + this.top_thickness + this.g + this.heel_length).toFixed(2);
}

GravityRetainingWall.prototype.leverArmX4 = function(){
    return (this.B / 2).toFixed(2);
}

GravityRetainingWall.prototype.leverArmX5 = function() {
    return (this.heel_length/2).toFixed(2);
}

GravityRetainingWall.prototype.leverArmX6 = function() {
    return ((this.g /3) + this.heel_length).toFixed(2);
}

GravityRetainingWall.prototype.leverArmX7 = function(){
    return ((this.g + this.heel_length)/ 3).toFixed(2);
}

GravityRetainingWall.prototype.leverArmXh = function(){
    return (this.Ha / 3).toFixed(2);
}
...
GravityRetainingWall.prototype.summationM = function(){
    ...
    + Number(this.momentM5()) + Number(this.momentM6()) + Number(this.momentM7()) + Number(this.momentMh()) + Number(this.momentMv())).toFixed(2);
}
//Lever Arm of summation Rv
GravityRetainingWall.prototype.leverArmSignRv = function(){
    return (this.summationM()/this.summationRv()).toFixed(2);
}

GravityRetainingWall.prototype.eccentricity = function(leverArmSum){
    return (leverArmSum() - (this.B /2)).toFixed(2);
}

GravityRetainingWall.prototype.max_eccentricity = function(){
    return (this.B/6).toFixed(2);
}
...
GravityRetainingWall.prototype.Pmax = function(summationRv,leverArmSumRv){
    return ((summationRv()/ this.B) * (1 + ((6 * this.eccentricity(leverArmSumRv))/this.B))).toFixed(2);
}
...
GravityRetainingWall.prototype.factorOfSafety = function(){
    ...
    return ((this.summationRv() * this.Mathh.tan(this.phi)) / this.summationRh()).toFixed(2);
}
...
GravityRetainingWall.prototype.Pp = function(Hp){
    ...
    return ((0.5 * constants.r * Math.pow(Hp,2)) * this.Kp()).toFixed(2);
}

GravityRetainingWall.prototype.Kp = function(){
    return ((1 + this.Mathh._sin(this.phi1))/(1 - this.Mathh._sin(this.phi1))).toFixed(2);
}

GravityRetainingWall.prototype.w8 = function(Hp){
    if(isNaN(Hp)) throw new TypeError("Invalid argument");
    return ((Hp - this.f) * this.toe_length * constants.r).toFixed(2);
}
...
GravityRetainingWall.prototype.leverArmXp = function(Hp){
    if(isNaN(Hp)) throw new TypeError("Invalid argument");
    return (Hp/3).toFixed(2);
}

GravityRetainingWall.prototype.leverArmX8 = function(){
    return ((this.toe_length/2) + this.b + this.top_thickness + this.g + this.heel_length).toFixed(2);
}

//Moment
GravityRetainingWall.prototype.momentMp =  function(Hp){
    if(isNaN(Hp)) throw new TypeError("Invalid argument");
    return (this.Pp(Hp) * this.leverArmXp(Hp)).toFixed(2);
}

GravityRetainingWall.prototype.momentM8 = function(Hp){
    if(isNaN(Hp)) throw new TypeError("Invalid argument");
    return (this.w8(Hp) * this.leverArmX8()).toFixed(2);
}

GravityRetainingWall.prototype.summationRv_ = function(Hp){
    if(isNaN(Hp)) throw new TypeError("Invalid argument");
    return (Number(this.summationRv()) + Number(this.w8(Hp))).toFixed(2);
}
...
console.log(newme.activePressure())
